      ...
      <div className='d-flex justify-content-center align-items-center' style={{height:"80vh"}}>
        <div className='w-75 border border-2 border-light p-3'>
            ...
            <div className='d-flex justify-content-center'>
                ...
                <button className='btn btn-success me-3' onClick={()=>{dispatch(decrement())}}>- Decrement</button>
                <button className='btn btn-success me-3' onClick={()=>{dispatch(reset())}}>Reset</button>
            </div>
